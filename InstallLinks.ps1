...
Create-SymbolicLink -relativeTargetPath "Library\{{PROJECT_NAME}}" -absoluteLinkPath "C:\Data\Programs\Library\{{PROJECT_NAME}}"
Create-SymbolicLink -relativeTargetPath "Samples\{{PROJECT_NAME}}" -absoluteLinkPath "C:\Data\Programs\Samples\{{PROJECT_NAME}}"
Create-SymbolicLink -relativeTargetPath "Tests\{{PROJECT_NAME}}" -absoluteLinkPath "C:\Data\Programs\Tests\{{PROJECT_NAME}}"
